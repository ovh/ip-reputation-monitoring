...
project = 'ip-reputation-monitoring'
copyright = '2016, OVH'
author = 'OVH'
...
latex_documents = [
    (master_doc, 'ip-reputation-monitoring.tex', 'ip-reputation-monitoring Documentation',
     'OVH', 'manual'),
]
...
man_pages = [
    (master_doc, 'ip-reputation-monitoring', 'ip-reputation-monitoring Documentation',
     [author], 1)
]
