...
sys.path.insert(0, os.path.abspath('../../reputation'))
...
project = u'ip-reputation-monitoring'
copyright = u'2016, OVH'
author = u'OVH'
...
htmlhelp_basename = 'ip-reputation-monitoringdoc'
...
latex_documents = [
    (master_doc, 'ip-reputation-monitoring.tex', u'ip-reputation-monitoring Documentation',
     u'OVH', 'manual'),
]
...
man_pages = [
    (master_doc, 'ip-reputation-monitoring', u'ip-reputation-monitoring Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ip-reputation-monitoring', u'ip-reputation-monitoring Documentation',
     author, 'ip-reputation-monitoring', 'One line description of project.',
     'Miscellaneous'),
]
